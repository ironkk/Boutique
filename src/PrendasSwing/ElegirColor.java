...
public class ElegirColor extends javax.swing.JDialog {
    ...
    public ElegirColor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        colores = BSwing.misPrendas.colores();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (colores.isEmpty() || jComboBox1.getSelectedIndex()==0) {
            JOptionPane.showMessageDialog(this, "Escoge un Color", 
                    "Color Inválido", JOptionPane.ERROR_MESSAGE);
        } else {
            ColoresPrendas pc = new ColoresPrendas(null, true, colores);
