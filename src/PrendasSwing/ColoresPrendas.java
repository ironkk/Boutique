 ...
 * @author ironkk
 */
public class ColoresPrendas extends javax.swing.JDialog {
    ...
    public ColoresPrendas(java.awt.Frame parent, boolean modal,String color) {
        super(parent, modal);
        prendasCol = BSwing.misPrendas.prendasByColor(color);
